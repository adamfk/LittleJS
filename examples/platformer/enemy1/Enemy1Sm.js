...
class Enemy1Sm
{
    ...
    #HUNTING_enter()
    {
        ...
        // HUNTING behavior
        // uml: enter / { obj.useTile("mad"); }
        {
            // Step 1: execute action `obj.useTile("mad");`
            this.vars.obj.useTile("mad");
        } // end of behavior for HUNTING
    ...
    {
        // HUNTING behavior
        // uml: exit / { obj.resetTile(); }
        {
            // Step 1: execute action `obj.resetTile();`
            this.vars.obj.resetTile();
        } // end of behavior for HUNTING
    ...
    #INITIAL_enter()
    {
        ...
        // INITIAL behavior
        // uml: enter / { obj.useTile("sleeping"); }
        {
            // Step 1: execute action `obj.useTile("sleeping");`
            this.vars.obj.useTile("sleeping");
        } // end of behavior for INITIAL
    }
